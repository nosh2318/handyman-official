...
(function(){
  ...
  var FLOW={
   ...
   zh:{fl_change:'變更條件',resv_jp:'預約',
    ...
    cust_head:'👤 預約人資料',l_name:'姓名',l_kana:'姓名（英文）',l_phone:'電話',l_email:'電子郵件',req:'必填',ph_name:'山田 太郎',ph_kana:'Taro Yamada',ph_phone:'090-1234-5678',ph_email:'example@mail.com',email_note:'※ 電子郵件用於登入會員頁（查詢/變更預約）。',l_notes:'備註・需求（選填）',drv_diff:'駕駛人與預約人不同',drv_head:'駕駛人',ph_dname:'山田 花子',ph_dkana:'Hanako Yamada',
