...
(function(){
  var DICT={
    ja:{ ins_back:'← トップへ戻る', ins_title:'保険プラン一覧', ins_lead:'万が一に備えて、3つの補償プランをご用意しています。ご予約時にお選びいただけます。', ins_p1_nm:'基本プラン（保険付き）', ins_p1_ds:'基本補償のみが適用されるプランです。すべてのご予約に標準で付帯します。', ins_c_pd:'<b>対人・対物</b>：無制限（免責補償なし）', ins_c_car:'<b>車両補償</b>：車両時価総額まで（自己負担額 15万円）', ins_c_ph:'<b>人身損害補償</b>：3,000万円まで', ins_p2_nm:'基本プラン＋免責補償', ins_per:'/ 24時間', ins_p2_ds:'基本補償に加え、事故時にお客様が負担する自己負担額（免責額）を免除する制度です。', ins_p2_c1:'基本補償の内容をすべて含む', ins_p2_c2:'<b>車両補償の自己負担額 15万円を免除</b>', ins_reco:'★ おすすめ', ins_p3_nm:'基本プラン＋免責補償＋NOC補償（安心ワイドパック）', ins_p3_ds:'免責補償に＋550円（税込）で、休業補償（ノンオペレーションチャージ）も不要に。すべての補償をひとまとめにした一番安心なプランです。', ins_p3_c1:'免責補償の内容をすべて含む', ins_p3_c2:'<b>NOC（ノンオペレーションチャージ／休業補償）を免除</b>', ins_p3_c3:'損傷タイヤの修理代・ホイールキャップ紛失も補償', ins_note:'※ 金額はすべて税込・24時間あたりです。NOC（ノンオペレーションチャージ）＝事故・故障で車両が使用できない期間の休業補償です。補償内容の詳細は店舗までお問い合わせください。', ins_cta:'🚗 車を予約する',
      nav_cars:'車種一覧', nav_price:'ラインナップ', nav_news:'お知らせ', nav_book:'予約する',
      hero_copy:'旅は、目的地に着く前から<br>始まっている。',hero_copy2:'借りに行かず、<br>届けてもらう時代へ。',hero_copy3:'ホテルでもご自宅でも、<br>あなたの車をお届け。',hero_copy4:'スマートに借りて、<br>自由に走ろう。',hero_copy5:'那覇・札幌・高松。<br>旅の相棒はここに。',off_bar_pre:'初回ネット予約',off_sub:'コードをコピー→クーポン欄にご入力',off_go:'コードを取得 ▶',off_badge:'初回ネット予約 限定',off_lead:'ご予約画面のクーポン欄にコードをご入力ください',off_btn:'コードをコピーして予約へ進む',off_later:'あとで',off_code:'クーポンコード ',off_toast:'クーポンコード「{code}」をコピーしました。ご予約時にクーポン欄へご入力ください。',
    ...
    en:{ ins_back:'← Back to top', ins_title:'Insurance Plans', ins_lead:'For peace of mind, we offer three coverage plans. Choose one when you book.', ins_p1_nm:'Basic Plan (insurance included)', ins_p1_ds:'A plan with basic coverage only. Included as standard with every booking.', ins_c_pd:'<b>Bodily injury &amp; property damage</b>: Unlimited (no CDW)', ins_c_car:'<b>Vehicle damage</b>: Up to the market value of the vehicle (¥150,000 deductible)', ins_c_ph:'<b>Personal injury coverage</b>: Up to ¥30,000,000', ins_p2_nm:'Basic Plan + CDW', ins_per:'/ 24 hours', ins_p2_ds:'In addition to basic coverage, this waives the deductible you would pay in an accident.', ins_p2_c1:'Includes everything in the basic coverage', ins_p2_c2:'<b>Waives the ¥150,000 vehicle-damage deductible</b>', ins_reco:'★ Recommended', ins_p3_nm:'Basic + CDW + NOC (Anshin Wide Pack)', ins_p3_ds:'For an extra ¥550 (tax incl.) on top of CDW, the non-operation charge (NOC) is also waived. The most reassuring plan, bundling all coverage together.', ins_p3_c1:'Includes everything in the CDW plan', ins_p3_c2:'<b>Waives the NOC (non-operation charge)</b>', ins_p3_c3:'Also covers damaged-tire repair and lost wheel caps', ins_note:'* All prices include tax and are per 24 hours. NOC (non-operation charge) covers the period a vehicle cannot be used due to an accident or breakdown. For coverage details, please contact the store.', ins_cta:'🚗 Book a car',
      nav_cars:'Car Types', nav_price:'Cars & Rates', nav_news:'News', nav_book:'Book Now',
      hero_copy:'The journey begins<br>before you arrive.',hero_copy2:'No pickup.<br>Just delivery.',hero_copy3:'To your hotel or home,<br>your car delivered.',hero_copy4:'Rent smart.<br>Drive free.',hero_copy5:'Naha · Sapporo · Takamatsu.<br>Your travel partner.',off_bar_pre:'First online booking',off_sub:'Copy the code and enter it at checkout',off_go:'Get code ▶',off_badge:'First online booking only',off_lead:'Enter the code in the coupon field at checkout.',off_btn:'Copy code & continue to booking',off_later:'Later',off_code:'Coupon code ',off_toast:'Copied code \'{code}\'. Enter it in the coupon field at checkout.',
    ...
    zh:{ ins_back:'← 返回首頁', ins_title:'保險方案一覽', ins_lead:'為了以防萬一，我們備有三種保障方案，可於預約時選擇。', ins_p1_nm:'基本方案（含保險）', ins_p1_ds:'僅適用基本保障的方案，所有預約均標準附帶。', ins_c_pd:'<b>對人・對物</b>：無上限（不含免責補償）', ins_c_car:'<b>車輛補償</b>：至車輛時價總額（自負額 15萬日圓）', ins_c_ph:'<b>人身損害補償</b>：至 3,000萬日圓', ins_p2_nm:'基本方案＋免責補償', ins_per:'/ 24小時', ins_p2_ds:'在基本保障之外，免除事故時客戶需負擔的自負額（免責額）的制度。', ins_p2_c1:'包含基本保障的全部內容', ins_p2_c2:'<b>免除車輛補償的自負額 15萬日圓</b>', ins_reco:'★ 推薦', ins_p3_nm:'基本方案＋免責補償＋NOC補償（安心廣域套組）', ins_p3_ds:'在免責補償再加550日圓（含稅），連休業補償（NOC）也免除。將所有保障整合為一、最安心的方案。', ins_p3_c1:'包含免責補償的全部內容', ins_p3_c2:'<b>免除 NOC（休業補償）</b>', ins_p3_c3:'亦補償受損輪胎修理費與輪圈蓋遺失', ins_note:'※ 金額均含稅、以每24小時計。NOC（休業補償）＝因事故・故障導致車輛無法使用期間的補償。保障內容詳情請洽門市。', ins_cta:'🚗 預約車輛',
      nav_cars:'車型一覽', nav_price:'車輛與費用', nav_news:'公告', nav_book:'立即預約',
      hero_copy:'旅程，早在抵達之前<br>就已開始。',hero_copy2:'不必取車，<br>直接送達的時代。',hero_copy3:'飯店或自宅，<br>直接為您送車。',hero_copy4:'聰明租車，<br>自由馳騁。',hero_copy5:'那霸・札幌・高松，<br>旅途夥伴在此。',off_bar_pre:'首次網路預約',off_sub:'複製代碼→於預約頁輸入',off_go:'取得代碼 ▶',off_badge:'首次網路預約限定',off_lead:'請於預約頁的優惠券欄輸入代碼。',off_btn:'複製代碼並前往預約',off_later:'稍後',off_code:'優惠券代碼 ',off_toast:'已複製代碼「{code}」，請於預約頁的優惠券欄輸入。',
    ...
    ko:{ ins_back:'← 처음으로', ins_title:'보험 플랜 목록', ins_lead:'만일에 대비해 3가지 보상 플랜을 준비했습니다. 예약 시 선택하실 수 있습니다.', ins_p1_nm:'기본 플랜(보험 포함)', ins_p1_ds:'기본 보상만 적용되는 플랜입니다. 모든 예약에 기본 포함됩니다.', ins_c_pd:'<b>대인・대물</b>: 무제한(면책보상 없음)', ins_c_car:'<b>차량 보상</b>: 차량 시가 총액까지(자기부담금 15만 엔)', ins_c_ph:'<b>인신 손해 보상</b>: 3,000만 엔까지', ins_p2_nm:'기본 플랜＋면책보상', ins_per:'/ 24시간', ins_p2_ds:'기본 보상에 더해, 사고 시 고객이 부담하는 자기부담금(면책액)을 면제하는 제도입니다.', ins_p2_c1:'기본 보상 내용을 모두 포함', ins_p2_c2:'<b>차량 보상 자기부담금 15만 엔 면제</b>', ins_reco:'★ 추천', ins_p3_nm:'기본＋면책보상＋NOC 보상(안심 와이드 팩)', ins_p3_ds:'면책보상에 550엔(세금 포함)을 더하면 휴업보상(NOC)도 불필요. 모든 보상을 하나로 묶은 가장 안심되는 플랜입니다.', ins_p3_c1:'면책보상 내용을 모두 포함', ins_p3_c2:'<b>NOC(휴업보상) 면제</b>', ins_p3_c3:'손상 타이어 수리비・휠캡 분실도 보상', ins_note:'※ 금액은 모두 세금 포함・24시간당입니다. NOC(휴업보상)＝사고・고장으로 차량을 사용할 수 없는 기간의 보상입니다. 보상 내용 상세는 매장으로 문의해 주세요.', ins_cta:'🚗 차량 예약하기',
      nav_cars:'차종 목록', nav_price:'차량 및 요금', nav_news:'공지', nav_book:'예약하기',
      hero_copy:'여행은 목적지에 도착하기 전부터<br>시작됩니다.',hero_copy2:'가지러 가지 않고,<br>배달받는 시대로.',hero_copy3:'호텔이든 자택이든,<br>당신의 차를 배달.',hero_copy4:'스마트하게 빌려서,<br>자유롭게 달리자.',hero_copy5:'나하·삿포로·다카마쓰.<br>여행의 파트너가 여기에.',off_bar_pre:'첫 온라인 예약',off_sub:'코드 복사 → 예약 시 입력',off_go:'코드 받기 ▶',off_badge:'첫 온라인 예약 한정',off_lead:'예약 화면의 쿠폰 칸에 코드를 입력하세요.',off_btn:'코드 복사 후 예약하기',off_later:'나중에',off_code:'쿠폰 코드 ',off_toast:'코드 \'{code}\'를 복사했습니다. 예약 시 쿠폰 칸에 입력하세요.',
  ...
  var FLOW={
   ...
   en:{fl_change:'Change search',resv_jp:'Reservation',
    ...
    cust_head:'👤 Booker details',l_name:'Name',l_kana:'Name (English)',l_phone:'Phone',l_email:'Email',req:'required',ph_name:'Taro Yamada',ph_kana:'Taro Yamada',ph_phone:'090-1234-5678',ph_email:'example@mail.com',email_note:'※ Your email is used to log in to My Page (view/change booking).',l_notes:'Notes / requests (optional)',drv_diff:'Driver is different from the booker',drv_head:'Driver',ph_dname:'Hanako Yamada',ph_dkana:'Hanako Yamada',
   ...
   zh:{fl_change:'變更條件',resv_jp:'預約',
    ...
    cust_head:'👤 預約人資料',l_name:'姓名',l_kana:'姓名（英文）',l_phone:'電話',l_email:'電子郵件',req:'必填',ph_name:'王 大明',ph_kana:'Taro Yamada',ph_phone:'090-1234-5678',ph_email:'example@mail.com',email_note:'※ 電子郵件用於登入會員頁（查詢/變更預約）。',l_notes:'備註・需求（選填）',drv_diff:'駕駛人與預約人不同',drv_head:'駕駛人',ph_dname:'王 美玲',ph_dkana:'Hanako Yamada',
   ...
   ko:{fl_change:'조건 변경',resv_jp:'예약',
    ...
    cust_head:'👤 예약자 정보',l_name:'성명',l_kana:'성명(영문)',l_phone:'전화번호',l_email:'이메일',req:'필수',ph_name:'야마다 타로',ph_kana:'Taro Yamada',ph_phone:'090-1234-5678',ph_email:'example@mail.com',email_note:'※ 이메일은 마이페이지(예약 확인·변경) 로그인에 사용됩니다.',l_notes:'비고·요청(선택)',drv_diff:'운전자가 예약자와 다름',drv_head:'운전자',ph_dname:'야마다 하나코',ph_dkana:'Hanako Yamada',
  ...
  // ===== 確認明細 / 受取詳細 / 札幌デリバリー地図 =====
  var FLOW2={
   ja:{coupon_head:'🎟 クーポン',cp_ph:'クーポンコードを入力',cp_apply:'適用',cp_hint:'※ お持ちのクーポンコードを入力してください。',cf_coupon:'クーポン割引',cp_ok2:'✅ クーポンを適用しました（-{amt}）',cp_ng:'⚠️ 有効なクーポンコードではありません。',cf_edit:'✏️ 変更',cf_store:'店舗',cf_recvm:'受取方法',cf_base:'基本料金',cf_optfee:'オプション',cf_insfee:'補償',cf_total:'合計',cf_rcv_dt:'受取日時',cf_rcv_pl:'受取場所',cf_col_dt:'回収日時',cf_col_pl:'回収場所',cf_use:'ご利用',cf_booker:'ご予約者',cf_none:'なし',cf_days_unit:'日間',cf_x:'×',
   ...
   en:{coupon_head:'🎟 Coupon',cp_ph:'Enter coupon code',cp_apply:'Apply',cp_hint:'* Enter your coupon code.',cf_coupon:'Coupon discount',cp_ok2:'✅ Coupon applied (-{amt})',cp_ng:'⚠️ That is not a valid coupon code.',cf_edit:'✏️ Edit',cf_store:'Store',cf_recvm:'Pickup method',cf_base:'Base fare',cf_optfee:'Options',cf_insfee:'Coverage',cf_total:'Total',cf_rcv_dt:'Pickup date',cf_rcv_pl:'Pickup place',cf_col_dt:'Return date',cf_col_pl:'Collect place',cf_use:'Duration',cf_booker:'Booker',cf_none:'None',cf_days_unit:'day(s)',cf_x:'×',
   ...
   zh:{coupon_head:'🎟 優惠券',cp_ph:'輸入優惠券代碼',cp_apply:'套用',cp_hint:'※ 請輸入您的優惠券代碼。',cf_coupon:'優惠券折扣',cp_ok2:'✅ 已套用優惠券（-{amt}）',cp_ng:'⚠️ 並非有效的優惠券代碼。',cf_edit:'✏️ 變更',cf_store:'門市',cf_recvm:'取車方式',cf_base:'基本費用',cf_optfee:'選項',cf_insfee:'保障',cf_total:'合計',cf_rcv_dt:'取車時間',cf_rcv_pl:'取車地點',cf_col_dt:'還車時間',cf_col_pl:'收車地點',cf_use:'租用',cf_booker:'預約人',cf_none:'無',cf_days_unit:'日',cf_x:'×',
   ...
   ko:{coupon_head:'🎟 쿠폰',cp_ph:'쿠폰 코드 입력',cp_apply:'적용',cp_hint:'※ 보유하신 쿠폰 코드를 입력하세요.',cf_coupon:'쿠폰 할인',cp_ok2:'✅ 쿠폰이 적용되었습니다(-{amt})',cp_ng:'⚠️ 유효한 쿠폰 코드가 아닙니다.',cf_edit:'✏️ 변경',cf_store:'매장',cf_recvm:'수령 방법',cf_base:'기본요금',cf_optfee:'옵션',cf_insfee:'보장',cf_total:'합계',cf_rcv_dt:'수령 일시',cf_rcv_pl:'수령 장소',cf_col_dt:'반납 일시',cf_col_pl:'수거 장소',cf_use:'이용',cf_booker:'예약자',cf_none:'없음',cf_days_unit:'일간',cf_x:'×',
  ...
  // ===== ハンバーガーメニュー項目（全ページ共通） =====
  var MENU={
   ja:{mn_resv_check:'🔑 予約確認',mn_guide_nha:'ご利用方法（沖縄那覇店）',mn_guide_spk:'ご利用方法（札幌店）',mn_cars:'ラインナップ',mn_ins:'保険プラン一覧',mn_faq_nha:'よくある質問（沖縄那覇店）',mn_faq_spk:'よくある質問（札幌店）',mn_contact:'お問い合わせ',mn_bus:'空港送迎バス',
   ...
   en:{mn_resv_check:'🔑 My Booking',mn_guide_nha:'How to use (Naha, Okinawa)',mn_guide_spk:'How to use (Sapporo)',mn_cars:'Cars & Rates',mn_ins:'Insurance plans',mn_faq_nha:'FAQ (Naha, Okinawa)',mn_faq_spk:'FAQ (Sapporo)',mn_contact:'Contact',mn_bus:'Airport shuttle bus',
   ...
   zh:{mn_resv_check:'🔑 預約查詢',mn_guide_nha:'使用方式（沖繩那覇店）',mn_guide_spk:'使用方式（札幌店）',mn_cars:'車輛與費用',mn_ins:'保險方案一覽',mn_faq_nha:'常見問題（沖繩那覇店）',mn_faq_spk:'常見問題（札幌店）',mn_contact:'聯絡我們',mn_bus:'機場接送巴士',
   ...
   ko:{mn_resv_check:'🔑 예약 확인',mn_guide_nha:'이용 방법(오키나와 나하점)',mn_guide_spk:'이용 방법(삿포로점)',mn_cars:'차량 및 요금',mn_ins:'보험 플랜 목록',mn_faq_nha:'자주 묻는 질문(오키나와 나하점)',mn_faq_spk:'자주 묻는 질문(삿포로점)',mn_contact:'문의',mn_bus:'공항 셔틀버스',
